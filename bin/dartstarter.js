// Generated by dart2js, the Dart to JavaScript compiler version: 1.25.0-dev.11.0.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: function() {
      var account1, output;
      P.print("Hello, World!");
      account1 = new L.BankAccount("11111", 10000);
      P.print(account1);
      P.print("Making 2000.0 withdrawal");
      account1.balance -= 2000;
      P.print("Status of account is now as follows");
      P.print(account1);
      P.print("MAking 12000.0 deposit");
      account1.balance += 12000;
      P.print("Status of account is now as follows");
      P.print(account1);
      P.print(account1.balance);
      P.print("Confirmed");
      switch ("Ngenge") {
        case "Ngenge":
          output = "Ngenge";
      ...
      P.print("Output is " + output);
      P.print("Testing while loop");
      L.testWhile();
      P.print("Testing do while");
      L.testDoWhile();
      P.print("Testing string compare");
      P.print("Comparing Ngenge to Ngenge gives:0");
    },
    testWhile: function() {
      for (var start = 1; start < 10;) {
        if (start % 2 === 0)
          H.printString("" + start + " is even");
        else
          H.printString("" + start + " is odd");
        ++start;
      }
    },
    testDoWhile: function() {
      var start = 1;
      do {
        H.printString("" + start + " is now the number concerned");
        ++start;
      } while (start < 20);
    },
    BankAccount: {
      "^": "Object;accNo,balance",
      toString$0: function(_) {
        return "BankAccount{accNo: " + this.accNo + ", balance: " + this.balance + "}";
      }
    }
  }, 1]];
  setupProgram(dart, 0);
...
//# sourceMappingURL=dartstarter.js.map
